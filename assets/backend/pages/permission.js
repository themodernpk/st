...
var vm = new Vue({
    ...
    ready: function () {
        ...
        this.url.read = this.base_url + "/read";
        this.url.update = this.base_url + "/update";
    ...
    methods: {
        ...
        updateItem: function (e) {
            ...
            this.element = event.currentTarget;
            $(this.element).find("i").removeClass("fa-save").addClass("fa-spinner").addClass("fa-spin");

            this.$http.post(this.url.update, this.item).then((response) => {
                console.log("response", response.data);
                $(this.element).find("i").addClass("fa-save").removeClass("fa-spinner").removeClass("fa-spin");
                this.fetchList();
            }, (response) => {
                // error callback
            });
